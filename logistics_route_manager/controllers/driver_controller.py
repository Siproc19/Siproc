...
class DriverAppController(http.Controller):
    ...
    def driver_app(self, **kwargs):
        ...
        gps_interval = int(request.env['ir.config_parameter'].sudo().get_param(
    ...
    @http.route('/logistics/task/<int:task_id>/arrived', type='json', auth='user', methods=['POST'])
    ...
    @http.route('/logistics/task/<int:task_id>/complete', type='json', auth='user', methods=['POST'])
    ...
    @http.route('/logistics/task/<int:task_id>/fail', type='json', auth='user', methods=['POST'])
    ...
    def pwa_manifest(self, **kwargs):
        ...
        manifest = {
            ...
            "icons": [
                {"src": "/logistics_route_manager/static/src/img/icon-192.png", "sizes": "192x192", "type": "image/png"},
                {"src": "/logistics_route_manager/static/src/img/icon-512.png", "sizes": "512x512", "type": "image/png"},
            ]
        }
